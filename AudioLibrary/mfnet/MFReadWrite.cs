...
namespace MediaFoundation.ReadWrite
{
    ...
    public interface IMFSourceReader
    {
        ...
        HResult ReadSample(
            ...
            IntPtr pdwActualStreamIndex, // out int pdwActualStreamIndex,  need to be able to pass NULL
            IntPtr pdwStreamFlags, // out  MF_SOURCE_READER_FLAG pdwStreamFlags,
            IntPtr pllTimestamp, // out long pllTimestamp,
            IntPtr ppSample // out IMFSample ppSample
        );
